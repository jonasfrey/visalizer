...
o_wsmsg__o_scantarget__create.f_v_server_implementation = async function(
    ...
    let o_data = await f_o_scantarget__from_s_path(o_wsmsg.v_data.s_path_absolute);
    let o_created = o_wsmsg__syncdata.f_v_sync({
        s_name_table: 'a_o_scantarget',
        s_operation: 'create',
        o_data: o_data
    });
    return o_created;
...
o_wsmsg__o_scantarget__delete.f_v_server_implementation = function(o_wsmsg) {
    let o_deleted = o_wsmsg__syncdata.f_v_sync({
        s_name_table: 'a_o_scantarget',
        s_operation: 'delete',
        o_data: { n_id: o_wsmsg.v_data.n_id }
    });
    return o_deleted;
};
